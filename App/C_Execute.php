...
<?php
    class Controller_Execute
    {
        ...
        public function doGet(){
            ...
            $data['code'] = IOHelper::ReadFile1($filePath);
...
<?php
    ...
    function ReadInput($inputPath){
        ...
        {
            $input = IOHelper::ReadFile1($inputPath);
            return $input;
        }
        else return " ";
    }
    function ReadOutput($outputPath, $errorPath){
        ...
        {   
            $content = IOHelper::ReadFile1($outputPath);
...
?>
<?php
    $controller = new Controller_Execute();
